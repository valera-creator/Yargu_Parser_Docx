...
Если вы хотите начать установку tesseract с помощью программы, то Вы можете это сделать, запустив файл auto_install_tesseract.py, а затем вернуться к инструкциям по скачиванию  Tesseract с пункта про выбор языков.
